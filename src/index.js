module.exports = {
  ...
  cmaxes: ({ te_gerna, versiio = "index" }) => {
    try {
      const terspuda = require(`./src/cmaxes/${versiio}.js`).parse(te_gerna)
      return { tcini: "snada", "te spuda": terspuda, kampu: terspuda }
    } catch (e) {
      return { tcini: "fliba", "te spuda": e, kampu: e.toString() }
    }
  ...
  selmaho: ({ word, jsonDoc, bangu }) => {
    return require("./bangu/english.js").selmaho({ word, jsonDoc, bangu })
  },
  word: ({ word, jsonDoc }) => {
  ...
  zeizei: (te_gerna, returnFullInfo) => {
  ...
  anji: (te_gerna) => {
    return require("./ceha/anji.js")(
      te_gerna,
      module.exports.zeizei,
      module.exports.romoi_lahi_cmaxes
    )
  },
  modzi: (te_gerna, rawOutput) => {
    return require("./ceha/modzi.js")(
      te_gerna,
      module.exports.zeizei,
      module.exports.romoi_lahi_cmaxes,
      rawOutput
