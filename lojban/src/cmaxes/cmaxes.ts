...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c7 = function(expr: any): any {return [_join(expr),"-"];};
  const peg$c8 = function(expr: any): any {return [_join(expr)];};
  const peg$c9 = function(expi: any, exp: any): any {return [_join(expi),"-",_join(exp)];};
  const peg$c10 = function(exp: any, expr: any): any {return [_join(exp),"-",_join(expr)]};
  ...
  const peg$c29 = function(): any {return ["u",""]};
  const peg$c30 = /^[l]/;
  ...
  const peg$c57 = function(expr: any): any {return ["drata", _join(expr)];};
  const peg$c58 = /^[^ ]/;
  ...
  function peg$parsenul(): any {
    ...
    function _node_int(a: any): any
    {
      if (typeof(a) == "string") return a;
      let r = [];
      for (const v in a)  {r.push( _node_int( a[v] ) );}
      return r;
    }
